...
const CGEN_HW_ENTRY mcs_cgen_hw_table[] =
{
  ...
  { "h-oreg", HW_H_OREG, CGEN_ASM_KEYWORD,  &mcs_cgen_opval_h_oreg, { 0, { { { (1<<MACH_BASE), 0 } } } } },
  { "h-xoreg", HW_H_XOREG, CGEN_ASM_KEYWORD,  &mcs_cgen_opval_h_xoreg, { 0, { { { (1<<MACH_GTMMCSV3)|(1<<MACH_GTMMCSV31), 0 } } } } },
  { "h-wxreg", HW_H_WXREG, CGEN_ASM_KEYWORD,  &mcs_cgen_opval_h_wxreg, { 0, { { { (1<<MACH_GTMMCSV31), 0 } } } } },
  { "h-areg", HW_H_AREG, CGEN_ASM_KEYWORD,  &mcs_cgen_opval_h_areg, { 0, { { { (1<<MACH_BASE), 0 } } } } },
  { "h-greg", HW_H_GREG, CGEN_ASM_KEYWORD, &mcs_cgen_opval_h_greg, { 0, { { { (1<<MACH_GTMMCSV3)|(1<<MACH_GTMMCSV31), 0 } } } } },
  { "h-bareg", HW_H_BAREG, CGEN_ASM_KEYWORD, &mcs_cgen_opval_h_bareg, { 0, { { { (1<<MACH_GTMMCSV31), 0 } } } } },
...
const CGEN_MAYBE_MULTI_IFLD MCS_F_OPXA_MULTI_IFIELD [] =
{
    { 0, { &mcs_cgen_ifld_table[MCS_F_OPA_4] } },
    { 0, { &mcs_cgen_ifld_table[MCS_F_OPA_1] } },
    { 0, { 0 } }
};
const CGEN_MAYBE_MULTI_IFLD MCS_F_OPXB_MULTI_IFIELD [] =
{
    { 0, { &mcs_cgen_ifld_table[MCS_F_OPB_4] } },
    { 0, { &mcs_cgen_ifld_table[MCS_F_OPB_1] } },
    { 0, { 0 } }
};
...
/* pc: program counter */
  { "pc", MCS_OPERAND_PC, HW_H_PC, 0, 0,
    { 0, { &mcs_cgen_ifld_table[MCS_F_NIL] } }, 
