...
#define INDICES 0, 0
  ...
  {"abs.b",      1, 0x05c0000b, 0x0a3f0ff4, F(RR),   2, "dd",    "13",
		 TRICORE_GENERIC, INDICES},
  {"abs.df",     1, 0x0302004b, 0x0cfdf0b4, F(RR),   2, "DD",    "14",
		 TRICORE_V1_8_UP, INDICES},
  {"abs.f",      1, 0x0301004b, 0x0cfef0b4, F(RR),   2, "dd",    "14",
		 TRICORE_V1_8_UP, INDICES},  
  ...
  {"add.b",      1, 0x0400000b, 0x0bff00f4, F(RR),   3, "ddd",   "143",
		 TRICORE_GENERIC, INDICES},
  {"add.df",      1, 0x0022006b, 0x00ddf094, F(RRR),  3, "DDD",   "125",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"cachea.i",   1, 0x0b800089, 0x04400f76, F(BO),   2, "@0",    "21",
		 TRICORE_V1_2_UP, INDICES},
  {"cachea.i.vm",1, 0x03800049, 0x0c400fb6, F(BO),   2, ">0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachea.i.vm",1, 0x07800049, 0x08400fb6, F(BO),   2, "<0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachea.i.vm",1, 0x0b800049, 0x04400fb6, F(BO),   2, "@0",    "21",
		 TRICORE_V1_8_UP, INDICES},  
  ...
  {"cachea.w",   1, 0x0b000089, 0x04c00f76, F(BO),   2, "@0",    "21",
		 TRICORE_V1_2_UP, INDICES},
  {"cachea.w.vm",1, 0x03000049, 0x0cc00fb6, F(BO),   2, ">0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachea.w.vm",1, 0x07000049, 0x08c00fb6, F(BO),   2, "<0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachea.w.vm",1, 0x0b000049, 0x04c00fb6, F(BO),   2, "@0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"cachea.wi",  1, 0x0b400089, 0x04800f76, F(BO),   2, "@0",    "21",
		 TRICORE_V1_2_UP, INDICES},
  {"cachea.wi.vm",1, 0x03400049, 0x0c800fb6, F(BO),   2, ">0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachea.wi.vm",1, 0x07400049, 0x08800fb6, F(BO),   2, "<0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachea.wi.vm",1, 0x0b400049, 0x04800fb6, F(BO),   2, "@0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"cachei.i",   1, 0x0a800089, 0x05400f76, F(BO),   2, "@0",    "21",
  		 TRICORE_V1_6_UP, INDICES},
  {"cachei.i.vm",1, 0x02800049, 0x0d400fb6, F(BO),   2, ">0",    "21",
  		 TRICORE_V1_8_UP, INDICES},
  {"cachei.i.vm",1, 0x06800049, 0x09400fb6, F(BO),   2, "<0",    "21",
  		 TRICORE_V1_8_UP, INDICES},
  {"cachei.i.vm",1, 0x0a800049, 0x05400fb6, F(BO),   2, "@0",    "21",
  		 TRICORE_V1_8_UP, INDICES},
  ...
  {"cachei.w",   1, 0x0ac00089, 0x05000f76, F(BO),   2, "@0",    "21",
  		 TRICORE_V1_3_1_UP, INDICES},
  {"cachei.w.vm",1, 0x02c00049, 0x0d000fb6, F(BO),   2, ">0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachei.w.vm",1, 0x06c00049, 0x09000fb6, F(BO),   2, "<0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachei.w.vm",1, 0x0ac00049, 0x05000fb6, F(BO),   2, "@0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"cachei.wi",  1, 0x0bc00089, 0x04000f76, F(BO),   2, "@0",    "21",
  		 TRICORE_V1_3_1_UP, INDICES},
  {"cachei.wi.vm",1, 0x03c00049, 0x0c000fb6, F(BO),   2, ">0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachei.wi.vm",1, 0x07c00049, 0x08000fb6, F(BO),   2, "<0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  {"cachei.wi.vm",1, 0x0bc00049, 0x04000fb6, F(BO),   2, "@0",    "21",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"calla",      1, 0x000000ed, 0x00000012, F(B),    1, "T",     "1",
		 TRICORE_GENERIC, INDICES},
  {"calli",      0, 0x000010dc, 0xffffe023, F(SR),   1, "a",     "1",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"cmovn",      0, 0x000000ea, 0xffff0015, F(SRC),  3, "di4",   "201",
		 TRICORE_GENERIC, INDICES},
  {"cmp.df",     1, 0x0002004b, 0x0ffd00b4, F(RR),   3, "dDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"dextr",      1, 0x00800017, 0x007f00e8, F(RRRR), 4, "dddd",  "1432",
		 TRICORE_GENERIC, INDICES},
  {"dftof",      1, 0x0282004b, 0x0d7df0b4, F(RR),  2, "dD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftoi",      1, 0x0102004b, 0x0efdf0b4, F(RR),  2, "dD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftoin",     1, 0x0372004b, 0x0c8df0b4, F(RR),  2, "dD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftoiz",     1, 0x0132004b, 0x0ecdf0b4, F(RR),  2, "dD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftol",      1, 0x01a2004b, 0x0e5df0b4, F(RR),  2, "DD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftolz",     1, 0x01b2004b, 0x0e4df0b4, F(RR),  2, "DD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftou",      1, 0x0122004b, 0x0eddf0b4, F(RR),  2, "dD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftoul",     1, 0x01e2004b, 0x0e1df0b4, F(RR),  2, "DD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftoulz",    1, 0x01f2004b, 0x0e0df0b4, F(RR),  2, "DD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"dftouz",     1, 0x0172004b, 0x0e8df0b4, F(RR),  2, "dD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"div.f",      1, 0x0051004b, 0x0fae00b4, F(RR),   3, "ddd",   "143",
  		 TRICORE_V1_3_UP, INDICES},
  {"div.df",     1, 0x0052004b, 0x0fad00b4, F(RR),   3, "DDD",   "143",
  		 TRICORE_V1_8_UP, INDICES},
  {"div64",      1, 0x0202004b, 0x0dfd00b4, F(RR),   3, "DDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  {"div64.u",    1, 0x0212004b, 0x0ded00b4, F(RR),   3, "DDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"fret",       1, 0x00c0000d, 0xff3ffff2, F(SYS),  0, "",     "",
  		 TRICORE_V1_6_UP, INDICES},
  {"ftodf",      1, 0x0292004b, 0x0d6df0b4, F(RR),   2, "Dd",    "14",
		 TRICORE_V1_8_UP, INDICES},
  {"ftoi",       1, 0x0101004b, 0x0efef0b4, F(RR),   2, "dd",    "14",
  		 TRICORE_V1_3_UP, INDICES},
  {"ftoin",      1, 0x0371004b, 0x0c8ef0b4, F(RR),   2, "dd",    "14",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"hptof",      1, 0x0241004b, 0x0dbef0b4, F(RR),   2, "dd",    "14",
  		 TRICORE_V1_6_2_UP, INDICES},
  {"hvcall",     1, 0x004000ad, 0xffa00f52, F(RC),   1, "n",     "2",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"isync",      1, 0x04c0000d, 0xfb3ffff2, F(SYS),  0, "",      "",
		 TRICORE_GENERIC, INDICES},
  {"itodf",      1, 0x0142004b, 0x0ebdf0b4, F(RR),   2, "Dd",    "14",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"jnz.t",      1, 0x8000006f, 0x00000010, F(BRN),  3, "d5o",   "321",
		 TRICORE_GENERIC, INDICES},
  {"jri",        1, 0x0130002d, 0xfecff0d2, F(RR),   1, "a",     "4",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"ld.d",       1, 0x09400009, 0xf6bf00f6, F(BO),   2, "D@",    "32",
		 TRICORE_GENERIC, INDICES},
  {"ld.dd",      1, 0x02400009, 0x0d8000f6, F(BO),   3, "Q>0",   "321",
		  TRICORE_V1_8_UP, INDICES},
  {"ld.dd",      1, 0x06400009, 0x098000f6, F(BO),   3, "Q<0",   "321",
		 TRICORE_V1_8_UP, INDICES},
  {"ld.dd",      1, 0x0A400009, 0x048000f6, F(BO),   3, "Q@0",   "321",
		 TRICORE_V1_8_UP, INDICES},
  {"ld.dd",      1, 0x0A400009, 0xf4bf00f6, F(BO),   2, "Q@",    "32",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"loopu",      1, 0x800000fd, 0x0000ff02, F(BRR),  1, "o",     "1",
		 TRICORE_V1_2_UP, INDICES},
  {"lsync",      1, 0x0880000d, 0xf77ffff2, F(SYS),  0,  "",      "",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"lt.wu",      1, 0x0930000b, 0x06cf00f4, F(RR),   3, "ddd",   "143",
		 TRICORE_GENERIC, INDICES},
  {"ltodf",      1, 0x0262004b, 0x0d9df0b4, F(RR),  2, "DD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"madd.f",     1, 0x0061006b, 0x009e0094, F(RRR),  4, "dddd",  "1254",
		 TRICORE_V1_3_UP, INDICES},
  {"madd.df",    1, 0x0062006b, 0x009d0094, F(RRR),  4, "DDDD",  "1254",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"max.bu",     1, 0x05b0000b, 0x0a4f00f4, F(RR),   3, "ddd",   "143",
		 TRICORE_GENERIC, INDICES},
  {"max.df",     1, 0x0322004b, 0x0cdd00b4, F(RR),   3, "DDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  {"max.f",      1, 0x0321004b, 0x0cde00b4, F(RR),   3, "ddd",   "143",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"mfcr",       1, 0x0000004d, 0x00000fb2, F(RLC),  2, "dW",    "12",
		 TRICORE_GENERIC, INDICES},
  {"mfdcr",      1, 0x0000004f, 0x00000fb0, F(RLC),  2, "DW",    "12",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"min.bu",     1, 0x0590000b, 0x0a6f00f4, F(RR),   3, "ddd",   "143",
		 TRICORE_GENERIC, INDICES},
  {"min.df",     1, 0x0332004b, 0x0ccd00b4, F(RR),   3, "DDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  {"min.f",      1, 0x0331004b, 0x0cce00b4, F(RR),   3, "ddd",   "143",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"msub.f",     1, 0x0071006b, 0x008e0094, F(RRR),  4, "dddd",  "1254",
		 TRICORE_V1_3_UP, INDICES},
  {"msub.df",    1, 0x0072006b, 0x008d0094, F(RRR),  4, "DDDD",  "1254",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"mtcr",       1, 0x000000cd, 0xf0000032, F(RLC),  2, "Wd",    "23",
		 TRICORE_GENERIC, INDICES},
  {"mtdcr",      1, 0x000000cf, 0xf0000030, F(RLC),  2, "WD",    "23",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"mul.f",      1, 0x0041004b, 0x0fbe00b4, F(RR),   3, "ddd",   "143",
		 TRICORE_V1_3_UP, INDICES},
  {"mul.df",     1, 0x0042004b, 0x0fbd00b4, F(RR),   3, "DDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"mulr.q",     1, 0x001c0093, 0x0fe0006c, F(RR1),  4, "dgg1",  "1432",
		 TRICORE_V1_2_UP, INDICES},
  {"mulp.b",     1, 0x02b0004b, 0x0d4f004b, F(RR),   3, "Ddd",   "143",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"ne.a",       1, 0x04100001, 0x0bef00fe, F(RR),   3, "daa",   "143",
		 TRICORE_GENERIC, INDICES},
  {"neg.df",     1, 0x0312004b, 0x0cedf0b4, F(RR),   2, "DD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"neg.f",      1, 0x0311004b, 0x0ceef0b4, F(RR),   2, "dd",   "14",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"qseed.f",    1, 0x0191004b, 0x0e6ef0b4, F(RR),   2, "dd",    "14",
		 TRICORE_V1_3_UP, INDICES},
  {"qseed.df",   1, 0x0192004b, 0x0e6df0b4, F(RR),   2, "DD",    "14",
		 TRICORE_V1_8_UP, INDICES},
  {"rem64",      1, 0x0342004b, 0x0cbd00b4, F(RR),   3, "DDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  {"rem64.u",    1, 0x0352004b, 0x0cad00b4, F(RR),   3, "DDD",   "143",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"ret",        1, 0x0180000d, 0xfe7ffff2, F(SYS),  0, "",      "",
		 TRICORE_V1_2_UP, INDICES},
  {"rfh",        1, 0x05c0000d, 0xfa3ffff2, F(SYS),  0, "",      "",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"st.d",       1, 0x09400089, 0xf6bf0076, F(BO),   2, "@D",    "23",
		 TRICORE_GENERIC, INDICES},
  {"st.dd",      1, 0x02400089, 0x0d800076, F(BO),   3, ">0Q",   "213",
		 TRICORE_V1_8_UP, INDICES},
  {"st.dd",      1, 0x06400089, 0x09800076, F(BO),   3, "<0Q",   "213",
		 TRICORE_V1_8_UP, INDICES},
  {"st.dd",      1, 0x0A400089, 0x04800076, F(BO),   3, "@0Q",   "213",
		 TRICORE_V1_8_UP, INDICES},
  {"st.dd",       1, 0x0A400089, 0xf4bf0076, F(BO),   2, "@Q",    "23",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"sub.f",      1, 0x0031006b, 0x00cef094, F(RRR),  3, "ddd",   "125",
		 TRICORE_V1_3_UP, INDICES},
  {"sub.df",     1, 0x0032006b, 0x00cdf094, F(RRR),  3, "DDD",   "125",
		 TRICORE_V1_8_UP, INDICES},
  ...
  {"tlbprobe.i", 1, 0x00900075, 0xff6ff08a, F(RR),   1, "d",     "4",
		 TRICORE_V1_3_UP, INDICES},
  {"trapinv",    0, 0x00000036, 0xffffffc9, F(SR),   0, "",      "",
                 TRICORE_V1_8_UP, INDICES},
  ...
  {"unpack",     1, 0x0080004b, 0x0f7ff0b4, F(RR),   2, "Dd",   "14",
		 TRICORE_V1_2_UP, INDICES},
  {"ultodf",     1, 0x0272004b, 0x0d8df0b4, F(RR),   2, "DD",   "14",
		 TRICORE_V1_8_UP, INDICES},
  {"updfl",      1, 0x00c1004b, 0x0f3ef0b4, F(RR),   1, "d",    "5",
		 TRICORE_V1_3_UP, INDICES},
  {"utodf",      1, 0x0162004b, 0x0e9df0b4, F(RR),   2, "Dd",   "14",
		 TRICORE_V1_8_UP, INDICES},
